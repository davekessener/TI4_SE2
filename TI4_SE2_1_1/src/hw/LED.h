...
namespace hw
{
	...
	class LED : public lib::LockableObject<LED>
	{
		public:
			...
			static const led_t START  = MXT_PINPORT(HWAccessImpl::PORT_C, 0x00); // port C pin 0
			static const led_t RESET  = MXT_PINPORT(HWAccessImpl::PORT_C, 0x01); // port C pin 1
			static const led_t Q1     = MXT_PINPORT(HWAccessImpl::PORT_C, 0x02); // port C pin 2
			static const led_t Q2     = MXT_PINPORT(HWAccessImpl::PORT_C, 0x04); // port C pin 3
